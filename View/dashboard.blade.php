...
<body id="page-top">
    ...
    <div id="wrapper">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Feature User</h6>
                        <a class="collapse-item" href="">Add User</a>
                        <a class="collapse-item" href="">Edit User</a>
                        <a class="collapse-item" href="{{ url('userlist') }}">User List</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Informatics Student
                                    Club</span>
                                <img class="img-profile rounded-circle" src="asset/images.png" />
                            </a>
        ...
        <script src="asset/chart-pie-demo.js"></script>
</body>
